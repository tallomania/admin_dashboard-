        ...
        <div className="mt-16">
            <div className="flex flex-wrap lg:flex-nowrap justify-center ">
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg  h-44 rounded-xl w-full  lg:w-80 p-8 pt-9 m-3 bg-hero-pattern  dark:bg-switch bg-no-repeat bg-cover bg-center">
                    <div className="flex justify-between items-center">
                        <div>
                            <p className="font-bold dark:text-gray-300 text-gray-900 text-lg">Earnings ($)</p>
                            <p className="text-2xl dark:text-gray-500">90,253,456.54</p>
                        </div>
                        <button
                            type="button"
                            style={{ backgroundColor: currentColor }}
                            className="text-2xl opacity-0.9 text-gray-400 hover:drop-shadow-xl rounded-full p-4 "
                        >
                            <BsCurrencyDollar />
                        </button>
                    </div>
            ...
            <div className="flex gap-10 flex-wrap justify-center">
                        ...
                        <div className="border-r-1 border-color m-4 pr-10">
                            <div>
                                <p>
                                    ...
                                    <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-gradient-to-bl from-cyan-300 to-green-600 ml-3 text-xs">
                                        23%
                                    </span>
                                </p>
                ...
                <div>
                    ...
                    <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 gap-10 ">
                        <div className="flex justify-between items-center" >
                            <div>
                        ...
                        <button
                            type="button"
                            style={{ backgroundColor: currentColor }}
                            className="text-2xl opacity-0.9 text-gray-400 hover:drop-shadow-xl rounded-full p-5 "
                        >
                            <BsCurrencyDollar />
                        </button>
                            </div>
            ...
            <div className="flex gap-10 m-4 flex-wrap justify-center ">
                ...
                <div className="bg-white dark:texxt-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl w-96 md:w-760">
                    <div className="flex justify-between items-center gap-2 mb-10">
                        <p className="text-xl font-semibold dark:text-gray-200">Sales Reviews</p>
                        <DropDown currentMode={currentMode} />
                    </div>
            ...
            <div className="flex flex-wrap justify-center">
                ...
                <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
                    ...
                    <div className="mt-10">
                        <img className="md:w-96 h-50 " src={product4} alt="" />
                        <div className="mt-8">
                            <p className="font-semibold text-lg">React 18 coming soon!</p>
                            <p className="text-gray-400 ">By Gabriel</p>
